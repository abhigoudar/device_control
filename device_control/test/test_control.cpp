...
class DeviceSystem1 : public device_control::ControlledLifecycleNode
{
public:
  explicit DeviceSystem1(const std::string & id)
  ...
  device_control_msgs::msg::Control last_msg_;
...
{
  auto node_1 = std::make_shared<DeviceSystem1>("device_system_1");
  auto node_2 = std::make_shared<DeviceSystem1>("device_system_2");
  ...
  ASSERT_TRUE(
    env_infos[0].device_source == "device_system_1" ||
    env_infos[0].device_source == "device_system_2");
  ASSERT_TRUE(
    env_infos[1].device_source == "device_system_1" ||
    env_infos[1].device_source == "device_system_2");
  ...
  control_node->start_system("session_2", {"device_system_1"});
  ...
  std::vector<device_control_msgs::msg::DeviceInfo> env_infos_late;
  auto env_sub_late = control_node->create_subscription<device_control_msgs::msg::DeviceInfo>(
    "device_environment",
    rclcpp::QoS(1000).reliable().transient_local().keep_all(),
    [&env_infos_late](const device_control_msgs::msg::DeviceInfo::SharedPtr msg) {
  ...
  ASSERT_TRUE(
    env_infos_late[0].device_source == "device_system_1" ||
    env_infos_late[0].device_source == "device_system_2");
  ASSERT_TRUE(
    env_infos_late[1].device_source == "device_system_1" ||
    env_infos_late[1].device_source == "device_system_2");
